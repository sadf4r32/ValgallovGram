...
public class SharedConfig {
    ...
    // Valgallov: Ghost Mode + extra features (defaults ON in this build; UI in ValgallovSettingsActivity)
    public static boolean ghostMode = true;
    public static boolean ghostNoRead = true;
    public static boolean ghostNoTyping = true;
    public static boolean ghostAlwaysOffline = true;
    public static boolean ghostStoriesNoTrace = true;
    public static boolean ghostNoVoiceListened = true;
    public static boolean valgallovShowDeleted = true;
    public static boolean valgallovSaveRestricted = true;
    public static boolean valgallovBlueThemeDefault = true;
    public static boolean valgallovNoContactsSync = true;
...
//    public static int saveToGalleryFlags;
    ...
    public static void loadConfig() {
        synchronized (sync) {
            ...
            // Valgallov: Ghost Mode — default ON in this build
            ghostMode = preferences.getBoolean("ghostMode", true);
            ghostNoRead = preferences.getBoolean("ghostNoRead", true);
            ghostNoTyping = preferences.getBoolean("ghostNoTyping", true);
            ghostAlwaysOffline = preferences.getBoolean("ghostAlwaysOffline", true);
            ghostStoriesNoTrace = preferences.getBoolean("ghostStoriesNoTrace", true);
            ghostNoVoiceListened = preferences.getBoolean("ghostNoVoiceListened", true);
            valgallovShowDeleted = preferences.getBoolean("valgallovShowDeleted", true);
            valgallovSaveRestricted = preferences.getBoolean("valgallovSaveRestricted", true);
            valgallovBlueThemeDefault = preferences.getBoolean("valgallovBlueThemeDefault", true);
            valgallovNoContactsSync = preferences.getBoolean("valgallovNoContactsSync", true);
    ...
    // Valgallov: Ghost Mode toggles
    public static void toggleGhostMode() {
        ghostMode = !ghostMode;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        preferences.edit().putBoolean("ghostMode", ghostMode).apply();
    }

    public static void toggleGhostNoRead() {
        ghostNoRead = !ghostNoRead;
        MessagesController.getGlobalMainSettings().edit().putBoolean("ghostNoRead", ghostNoRead).apply();
    }

    public static void toggleGhostNoTyping() {
        ghostNoTyping = !ghostNoTyping;
        MessagesController.getGlobalMainSettings().edit().putBoolean("ghostNoTyping", ghostNoTyping).apply();
    }

    public static void toggleGhostAlwaysOffline() {
        ghostAlwaysOffline = !ghostAlwaysOffline;
        MessagesController.getGlobalMainSettings().edit().putBoolean("ghostAlwaysOffline", ghostAlwaysOffline).apply();
    }

    public static void toggleGhostStoriesNoTrace() {
        ghostStoriesNoTrace = !ghostStoriesNoTrace;
        MessagesController.getGlobalMainSettings().edit().putBoolean("ghostStoriesNoTrace", ghostStoriesNoTrace).apply();
    }

    public static void toggleGhostNoVoiceListened() {
        ghostNoVoiceListened = !ghostNoVoiceListened;
        MessagesController.getGlobalMainSettings().edit().putBoolean("ghostNoVoiceListened", ghostNoVoiceListened).apply();
    }

    public static void toggleValgallovShowDeleted() {
        valgallovShowDeleted = !valgallovShowDeleted;
        MessagesController.getGlobalMainSettings().edit().putBoolean("valgallovShowDeleted", valgallovShowDeleted).apply();
    }

    public static void toggleValgallovSaveRestricted() {
        valgallovSaveRestricted = !valgallovSaveRestricted;
        MessagesController.getGlobalMainSettings().edit().putBoolean("valgallovSaveRestricted", valgallovSaveRestricted).apply();
    }

    public static void toggleValgallovBlueThemeDefault() {
        valgallovBlueThemeDefault = !valgallovBlueThemeDefault;
        MessagesController.getGlobalMainSettings().edit().putBoolean("valgallovBlueThemeDefault", valgallovBlueThemeDefault).apply();
    }

    public static void toggleValgallovNoContactsSync() {
        valgallovNoContactsSync = !valgallovNoContactsSync;
        MessagesController.getGlobalMainSettings().edit().putBoolean("valgallovNoContactsSync", valgallovNoContactsSync).apply();
    }

    public static void toggleValgallovLanguageEnabled() {
        valgallovLanguageEnabled = !valgallovLanguageEnabled;
        MessagesController.getGlobalMainSettings().edit().putBoolean("valgallovLanguageEnabled", valgallovLanguageEnabled).apply();
    }

    public static void toggleValgallovHiddenChatsEnabled() {
        valgallovHiddenChatsEnabled = !valgallovHiddenChatsEnabled;
        MessagesController.getGlobalMainSettings().edit().putBoolean("valgallovHiddenChatsEnabled", valgallovHiddenChatsEnabled).apply();
    }
